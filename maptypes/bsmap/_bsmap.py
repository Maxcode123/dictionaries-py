...
def _key_typecheck(key) -> None:
    ...
    if not hasattr(key, "__hash__") or getattr(key, "__hash__") is None:
...
class BSMapKeysIterator[KT](BSMapIterator):
    def __init__(self, _dict: BSMap) -> None:
        self._keys = _dict._keys
        self._current_index = -1
...
class BSMapValuesIterator[VT](BSMapIterator):
    def __init__(self, _dict: BSMap) -> None:
        self._values = _dict._values
        self._current_index = -1
...
class BSMapItemsIterator[KT, VT](BSMapIterator):
    def __init__(self, _dict: BSMap) -> None:
        self._keys = _dict._keys
        self._values = _dict._values
        self._current_index = -1
